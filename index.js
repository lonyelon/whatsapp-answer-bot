...
const FILE = "chats.json"; // File where the joined chats will be stored
...
const SETUP_MSG = "Vale, hecho"; // Message sent when the bot joins a chat
const TRIGGERS = [ // Triggers that make the bot always answer
    "ergio", "?"
];

const ANSWERS = [ // Bot responses to messages
    "Si", "si", "No", "no",
    "no se", "puede", "Puede", "No se", "A lo mejor si", "A lo mejor no",
    "mmmmmm",
    "Si? venga ya",
